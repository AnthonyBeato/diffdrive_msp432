...
#include "diffdrive_msp432/diffbot_system.hpp"
...
{
hardware_interface::CallbackReturn DiffDriveMSP432Hardware::on_init(
...
std::vector<hardware_interface::StateInterface> DiffDriveMSP432Hardware::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> DiffDriveMSP432Hardware::export_command_interfaces()
{
...
hardware_interface::CallbackReturn DiffDriveMSP432Hardware::on_configure(
...
hardware_interface::CallbackReturn DiffDriveMSP432Hardware::on_cleanup(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
hardware_interface::CallbackReturn DiffDriveMSP432Hardware::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
hardware_interface::CallbackReturn DiffDriveMSP432Hardware::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
hardware_interface::return_type DiffDriveMSP432Hardware::read(
...
hardware_interface::return_type diffdrive_msp432 ::DiffDriveMSP432Hardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_.connected())
  {
 ...
 // Print the values that will be sent to the motors
  RCLCPP_INFO(
    rclcpp::get_logger("DiffDriveMSP432Hardware"),
    "Sending motor values: left=%d, right=%d", motor_l_counts_per_loop, motor_r_counts_per_loop
  );
...
PLUGINLIB_EXPORT_CLASS(
  diffdrive_msp432::DiffDriveMSP432Hardware, hardware_interface::SystemInterface)
